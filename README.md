...
|- **[beta]** [consensus-mcp-hermes](https://github.com/ahmdngi/consensus-mcp-hermes) by [ahmdngi](https://github.com/ahmdngi) - Connect 200M+ peer-reviewed research papers to Hermes via the Consensus MCP server. Includes OAuth setup guide for headless environments, mcp-remote bridge config, and the full search tool parameter reference.
